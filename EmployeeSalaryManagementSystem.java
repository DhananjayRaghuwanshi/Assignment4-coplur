...
class PermanentEmployee extends Employee {
    ...
    private double calculateDeductions() {
        ...
        double insurance = grossPay * 0.03;
        double companyInsurance = grossPay * 0.05;
        double operationalExpenses = grossPay * 0.02;
...
class PayrollService {
    ...
    public void addEmployee(IEmployee employee, String password) {
        if ("manager123".equals(password)) {
            logger.info("New employee has been successfully added.");
        } else {
            logger.warning("Access Denied: Only managers can add employees.");
        }
    }
...
public class EmployeeSalaryManagementSystem {
    public static void main(String[] args) {
        ...
        // employees.add(new PermanentEmployee("John Doe", "emp001", "empPass1",
        // 1000000, 30000));
        // employees.add(new ContractEmployee("Jane Smith", "emp002", "empPass2", 100,
        // 8));
